...
venue: Hybrid - Zoom + limited in person space        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
address: Online & In-Person at Room 5.32, Bücklestraße 5, Konstanz, Germany      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
